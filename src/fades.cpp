...
class fades : public dsp {
 ...
 public:
	...
	virtual void buildUserInterface(UI* ui_interface) {
		ui_interface->openVerticalBox("The Fades");
		ui_interface->declare(&fHslider0, "name", "Fade Proportion");
		ui_interface->addHorizontalSlider("fade", &fHslider0, 1.0f, 1.0f, 4.0f, 0.00100000005f);
...
#ifndef PLUGIN_URI
#define PLUGIN_URI URI_PREFIX "/fades"
#endif
...
struct LV2Plugin {
      ...
      vd(num_voices>0?new VoiceData(num_voices):0)
  {
    ...
    dsp = (fades**)calloc(ndsps, sizeof(fades*));
...
#endif
  if (!plugin_name || !*plugin_name) plugin_name = "fades";
