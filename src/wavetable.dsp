declare name "Wavetable";
declare author "Gula Plugins";
declare copyright "Steve Baker (2022)";
declare license "GPLv3";
declare description "An LV2 plugin which uses guitar input to control wavetable synthesis";
...
process = so.loop_speed_level(soundfile("files [url: {'AnaMixedRes.wav'}]",1), part, speed, level);