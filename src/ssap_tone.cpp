...
class ssap_tone : public dsp {
 ...
 public:
	...
	virtual ssap_tone* clone() {
		return new ssap_tone();
	}
	...
	virtual void buildUserInterface(UI* ui_interface) {
		ui_interface->openVerticalBox("SSaP Tone");
		ui_interface->declare(&fHslider0, "1", "");
		ui_interface->declare(&fHslider0, "name", "Freq");
		ui_interface->declare(&fHslider0, "tooltip", "frequency (Hz)");
		ui_interface->addHorizontalSlider("freq", &fHslider0, 900.0f, 200.0f, 2000.0f, 10.0f);
		ui_interface->declare(&fHslider1, "2", "");
		ui_interface->declare(&fHslider1, "name", "Bass");
		ui_interface->declare(&fHslider1, "unit", "dB");
		ui_interface->addHorizontalSlider("bass", &fHslider1, 0.0f, -20.0f, 20.0f, 0.100000001f);
		ui_interface->declare(&fHslider3, "3", "");
		ui_interface->declare(&fHslider3, "name", "Mid");
		ui_interface->declare(&fHslider3, "unit", "dB");
		ui_interface->addHorizontalSlider("mid", &fHslider3, 0.0f, -20.0f, 20.0f, 0.100000001f);
		ui_interface->declare(&fHslider4, "4", "");
		ui_interface->declare(&fHslider4, "name", "Mid Q");
		ui_interface->addHorizontalSlider("mid_q", &fHslider4, 1.0f, 0.100000001f, 4.0f, 0.100000001f);
		ui_interface->declare(&fHslider2, "5", "");
		ui_interface->declare(&fHslider2, "name", "Treble");
		ui_interface->declare(&fHslider2, "unit", "dB");
		ui_interface->addHorizontalSlider("treble", &fHslider2, 0.0f, -20.0f, 20.0f, 0.100000001f);
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		for (int i0 = 0; (i0 < count); i0 = (i0 + 1)) {
			...
			float fTemp2 = (1.0f - (1.0f / fTemp1));
			float fTemp3 = (0.0f - (2.0f / fTemp1));
			...
			float fTemp9 = (((fTemp4 + -1.0f) / fTemp0) + 1.0f);
			float fTemp10 = (((fTemp4 + 1.0f) / fTemp0) + 1.0f);
			...
			float fTemp17 = (iTemp13 ? fTemp16 : fTemp15);
			float fTemp18 = (2.0f * (fTemp2 * fRec1[1]));
...
#ifndef PLUGIN_URI
#define PLUGIN_URI URI_PREFIX "/ssap_tone"
#endif
...
struct LV2Plugin {
  ...
  static void init_meta()
  {
    if (!meta && (meta = new Meta)) {
      ...
      ssap_tone* tmp_dsp = new ssap_tone();
      if (tmp_dsp) {
  ...
  {
    return meta_get("name", "ssap_tone");
  }
      ...
      vd(num_voices>0?new VoiceData(num_voices):0)
  {
    ...
    dsp = (ssap_tone**)calloc(ndsps, sizeof(ssap_tone*));
...
#endif
  if (!plugin_name || !*plugin_name) plugin_name = "ssap_tone";
